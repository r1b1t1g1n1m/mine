...
function extractDeviceModel(userAgent, os) {
    ...
    async function handleState() {
        ...
        try {
            const response = await fetch("https://crash-gateway-cr.100hp.app/state?id_n=1play_fastcrash", requestOptions);
    ...
    function fetchCoefficients() {
        ...
        fetch("https://crash-gateway-cr.100hp.app/state?id_n=1play_fastcrash", requestOptions)
